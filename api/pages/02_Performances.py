...
data_url = 'https://raw.githubusercontent.com/BastGiu/prevision_horses/master/data/df_perf_modele_2022-12-03__2022-12-08.csv'
...
with col4:
    pass
with col5:
    st.markdown(f'''<a href={link2} target="_self"><button style="background-color:White;">A propos</button></a>''', unsafe_allow_html=True)
