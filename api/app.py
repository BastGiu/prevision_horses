...
st.write("<h4> style='text-justify: center;'> ponAI est une intelligence artificielle (AI) qui fournit des tuyaux pour les courses hippiques du jour. Il s'agit d'un algorithme de machine learning qui est entrainé pour prédire les chevaux <i>placés</i>.\n </h4>", unsafe_allow_html=True)
st.write("\n")
# People images
